  ...
  const bgElement = (
    <>
      <style>{`
        ...
        .bg-orb-1 { animation: bgFloat 12s ease-in-out infinite; }
        .bg-orb-2 { animation: bgFloat 15s ease-in-out infinite reverse; }
        .bg-orb-3 { animation: bgFloat 10s ease-in-out infinite 3s; }
      `}</style>
      <div className="fixed inset-0 -z-10 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-[#0C66E4]/5 via-[#f0f5ff] to-[#22A06B]/5" />
        <div className="bg-orb-1 absolute top-[-20%] left-[-10%] w-[60%] h-[60%] rounded-full bg-[#0C66E4]/10 blur-[120px]" />
        <div className="bg-orb-2 absolute bottom-[-20%] right-[-10%] w-[50%] h-[50%] rounded-full bg-[#22A06B]/10 blur-[120px]" />
        <div className="bg-orb-3 absolute top-[30%] right-[15%] w-[30%] h-[30%] rounded-full bg-[#E34935]/5 blur-[100px]" />
      </div>
    </>
  )
      ...
      <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4">
        ...
        <div className="w-full max-w-md bg-white/95 backdrop-blur-sm border border-border rounded-md shadow-sm p-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
          <div className="flex items-center justify-center gap-2 mb-6">
            <div className="w-8 h-8 rounded bg-[#0c66e4] text-white flex items-center justify-center font-bold text-lg">M</div>
            <span className="text-xl font-bold tracking-tight text-[#172b4d]">MyBoard</span>
          </div>
