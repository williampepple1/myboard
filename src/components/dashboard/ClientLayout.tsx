  ...
  return (
    <div className="flex items-center justify-end gap-3 pt-5 border-t border-border mt-5">
      ...
      <button
        type="submit"
        disabled={loading}
        className="px-4 py-2 bg-primary hover:bg-blue-700 text-white text-sm font-medium rounded-lg transition-colors disabled:opacity-60 flex items-center gap-2"
      >
